...
for (let i = 0; i < data.length; i += 1) {
  ...
  <div class="modal-div-3">
    ...
    ${popupTagsValue(i)}
      ...
      See Live <i class="fa fa-external-link" aria-hidden="true"></i> <img src="pics/see-live.svg" alt="see live">
      </button>
      <button type="button" class="modal-btn">
      See Source
      <i class="fa fa-github-square" aria-hidden="true"></i> <img src="pics/see-source.svg" alt="see source">
      </button>
      </div>
    </div>
    </div>
